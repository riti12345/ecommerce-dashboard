...
<header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
  <div class="mdl-layout__header-row">
    ...
    <div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
      <label class="mdl-button mdl-js-button mdl-button--icon" for="search-vendor-history-info">
        <i class="material-icons">search</i>
      </label>
      <div class="mdl-textfield__expandable-holder">
        <input class="mdl-textfield__input" type="search" id="search-vendor-history-info" autocomplete="off" autofocus placeholder="Search..">
        <label class="mdl-textfield__label" for="search-vendor-history-info"></label>
      </div>
    </div>
            ...
            <tbody>
              <?php
	            ...
	            foreach($new_history as $key => $value) :
	                	// echo print_array();
	              echo "<tr class='history-info-row'>
	                      <td class='count'></td>
	                      <td class='mdl-data-table__cell--non-numeric'>".$value['item_name']."</td>
	                      <td>".$value['id']."</td>
                        <td>".$this->config->item($value['procure_slot'],'delivery_slot')."</td>
