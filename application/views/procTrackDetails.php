...
<header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
  <div class="mdl-layout__header-row">
    <span class="mdl-layout-title">Procurement History Info</span>
  ...
  <div class="mdl-layout__tab-bar mdl-js-ripple-effect">
    ...
    <a href="#scroll-tab-2" class="mdl-layout__tab mdl-layout__tab_3 tab_1 tab_switch">Purchase Order</a>
  </div>
</header>
<main class="mdl-layout__content mdl-color--grey-100 get_tid_uid" data-tid="<?= $tid;?>" data-uid="<?= $uid;?>">
  ...
  <section class="mdl-layout__tab-panel" id="scroll-tab-2">
    <div class="page-content">
      <div class="mdl-grid purchase_orderTab">
        <div class="mdl-cell mdl-cell--3-col mdl-cell--4-col-tablet mdl-cell--6-col-phone demoCardP_O hidden">
...
<dialog id="dialog" class="mdl-dialog print_width" style="width: 64%;height: auto;-webkit-box-shadow: 0px 0px 264px 194px rgba(0,0,0,0.75);
    ...
    <div class="mdl-dialog__content p_o_content">
    </div>
  </dialog>      
