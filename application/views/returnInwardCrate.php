<?php 
  ...
  $client_name = $this->input->get('cname');
  $InwardItems = get_all_return_inward($item_id);
  //echo print_Array($InwardItems);die;
?>
<header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
 <div class="mdl-layout__header-row">
  <span class="mdl-layout-title">Return Inward Crates</span>
            ...
            <table class="mdl-data-table_jit_head mdl-js-data-table">
              <tbody>
                ...
                <tr class="bill_add_row">
                  ...
                  <td>
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                      <input class="mdl-textfield__input mdl-textfield__input_border" type="text" id="inward_vendor" placeholder="" readonly="" value=<?= $client_name;?>>
                      <label class="mdl-textfield__label" for="inward_vendor">client</label>
                    </div>
                  </td>
                  <td>
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                  ...
                  <td>
                    <button class="mdl-button mdl-js-button mdl-button--icon mdl-button--colored" id="add_return_inward_crates" >
          ...
          <div class="mdl-card-event_add_jit mdl-card mdl-shadow--2dp inward_div">
            ...
            <div class="mdl-grid">
              <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet  mdl-cell--12-col-phone">
                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent hidden" data-items='' id="return_inward_submit" tabindex="12"><i class="material-icons">archive</i> Inward</button>
              </div>
            </div>
          </div>		          
      </div>
