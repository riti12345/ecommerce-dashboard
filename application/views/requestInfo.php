        ...
        <div class="mdl-grid">
          ...
          <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet  mdl-cell--12-col-phone">
            <div class="mdl-card-event mdl-card mdl-shadow--2dp mdl-card__hr_requestInfo" >
              ...
              echo"
              <div class ='status_div' ".$request_status[$request['status']].">
                <div class='mdl-cell mdl-cell--12-col mdl-cell--12-col-tablet  mdl-cell--12-col-phone'>
                  <div class='info_details'>
                    <span class='info_icon'><i class='material-icons' id='reqapprIcon'>reply</i></span>
                     <div class='mdl-tooltip mdl-tooltip--bottom' for='reqapprIcon'>Reply</div>
                    <div class='mdl-textfield mdl-js-textfield mdl-textfield--floating-label hr_request_h4'>
                      <textarea class='mdl-textfield__input' type='text' row='8' id='request_reply' placeholder='' tabindex='1'></textarea>
                      <label class='mdl-textfield__label' for='request_reply'>Reply</label>
                    </div>
                    <button style='width:15%;margin-left:5%;margin-top:10%;' class='mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent reply_request' data-id=".$id." tabindex='2'>Reply</button>
                  </div>
                </div>
              </div>";
              ?>
