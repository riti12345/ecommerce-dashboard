...
class Migration_Inventorywastage extends CI_Migration {
      public function up() {
            ...
            $this->dbforge->add_field("status tinyint(4) unsigned NOT NULL DEFAULT '1'");
            ...
            $this->dbforge->create_table('os_inventory_wastage');
      }

      public function down() {
        $this->dbforge->drop_table('os_inventory_wastage');
    }
