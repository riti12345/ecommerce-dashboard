...
<html>
	...
	<body>
		<table>
		    <thead>
				...
				<tr>
					...
					<th  colspan="16" style="text-align: left;"><b><?=date("d-m-Y",strtotime($data[0]['procure_date']))?></b></th>

				</tr>
				<tr>
					<th  colspan="2"  style="text-align: center;"><b>Name of Vendor</b></th>
					<th  colspan="16" style="text-align: left;"><b><?=$data[0]['data'][0]['vendor_name']?></b></th>
				</tr>
				<tr>
					<th colspan="2"  style="text-align: center;"><b>Company Name</b></th>
					<th colspan="16" style="text-align: left;"><b><?=$data[0]['data'][0]['company_name']?></b></th>
				</tr>
				<tr>
					<th colspan="2"  style="text-align: center;"><b>Address</b></th>
					<th colspan="16" style="text-align: left;"><b><?=$data[0]['data'][0]['address']?></b></th>
				</tr>
				<tr>
					<th colspan="2"  style="text-align: center;"><b>Contact No.</b></th>
					<th colspan="16" style="text-align: left;"><b><?=$data[0]['data'][0]['phone']?></b></th>
				</tr>
			</thead>
			<tbody>
				<tr>
		...
		<div>
			...
			<p>
			  <b style="margin-left:2%">Purchase Manager</b> 
